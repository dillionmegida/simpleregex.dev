...
Regular Expressions as I will explain in this course is not only applied to JavaScript; you can apply the knowledge you learn here to several other languages that support regular expressions.
