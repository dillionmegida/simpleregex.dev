...
youtubeId: xX4xtlgC1Vw
---

From the previous lesson <CourseLink path='lookahead' label='lookahead patterns' />, we saw how to match a string when it is "followed by" another string, and also when it is "NOT followed by" another string.
